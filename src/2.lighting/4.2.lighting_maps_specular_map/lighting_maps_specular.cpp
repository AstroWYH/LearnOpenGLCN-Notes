...
// lighting
glm::vec3 lightPos(1.2f, 1.0f, 2.0f); // wyh 灯的pos, 光源的位置
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.use();
        lightingShader.setVec3("light.position", lightPos); // wyh 灯的pos, 光源的位置
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, lightPos); // wyh 灯的pos, 光源的位置
